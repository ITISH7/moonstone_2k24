...
const TeamDetails = (props) => {
  ...
  const handleNext = () => {
    if (TeamMember.length < props.minsize) {
      ...
      const finalstep = props.activeStep < props.length -  3? false : true;
  ...
  const adddatahandler = () => {
    if (MemberName === "" || validateAdhaar(adharnumber) === "false") {
      ...
      axios
        .post("https://firebasestorage.googleapis.com/v0/b/moonstone-a6c54.appspot.com/o/images%2FWhatsApp%20Image%202024-03-07%20at%2011.19.45_f4b88450.jpgc9c9f1dd-51f6-4823-865c-f7f78b0b5b11?alt=media&token=5155ff22-efff-4593-b1dd-d571ceedb152r", {
